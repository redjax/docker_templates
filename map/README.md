...
- [security](../templates/security)
    - [docker_wazuh](../templates/security/docker_wazuh)
        - [scripts](../templates/security/docker_wazuh/scripts)  
...
- [misc](../templates/misc)
    - [project_templates](../templates/misc/project_templates)
        - [docker_wordpress-nginx](../templates/misc/project_templates/docker_wordpress-nginx)
            - [wordpress_sites](../templates/misc/project_templates/docker_wordpress-nginx/wordpress_sites)
            - [scripts](../templates/misc/project_templates/docker_wordpress-nginx/scripts)   
